...
export class SqueletteComponent {
  ...
  arbitrateTemperature = 20;
    ...
    async getWeatherData() {
        ...
        this.http.get(`${apiUrl}?latitude=${params.latitude}&longitude=${params.longitude}&hourly=temperature_2m`).subscribe((data: any) => {
  ...
  handleClickWeather(type: "sun" | "rain" | "snow") {
    switch (type) {
      case "sun":
